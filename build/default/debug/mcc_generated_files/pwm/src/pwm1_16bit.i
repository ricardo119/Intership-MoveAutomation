...
static void (*PWM1_PHASE_A_Slice1Output1_InterruptHandler)(void);
static void (*PWM1_PHASE_A_Slice1Output2_InterruptHandler)(void);
static void (*PWM1_PHASE_A_Period_InterruptHandler)(void);
static void PWM1_PHASE_A_Slice1Output1_DefaultInterruptHandler(void);
static void PWM1_PHASE_A_Slice1Output2_DefaultInterruptHandler(void);
static void PWM1_PHASE_A_Period_DefaultInterruptHandler(void);
...
void PWM1_PHASE_A_Initialize(void)
{
    ...
    PWM1_PHASE_A_Slice1Output1_SetInterruptHandler(PWM1_PHASE_A_Slice1Output1_DefaultInterruptHandler);
    PWM1_PHASE_A_Slice1Output2_SetInterruptHandler(PWM1_PHASE_A_Slice1Output2_DefaultInterruptHandler);
    PWM1_PHASE_A_Period_SetInterruptHandler(PWM1_PHASE_A_Period_DefaultInterruptHandler);
...
void PWM1_PHASE_A_SetSlice1Output1DutyCycleRegister(uint16_t registerValue)
{
    PWM1S1P1L = (uint8_t)(registerValue);
    PWM1S1P1H = (uint8_t)(registerValue >> 8);
}

void PWM1_PHASE_A_SetSlice1Output2DutyCycleRegister(uint16_t registerValue)
{
...
void PWM1_PHASE_A_PWMI_ISR(void)
{
    ...
    {
        PWM1GIRbits.S1P1IF = 0;
        if(PWM1_PHASE_A_Slice1Output1_InterruptHandler != ((void*)0))
        {
            PWM1_PHASE_A_Slice1Output1_InterruptHandler();
        }
    }
    else if((PWM1GIEbits.S1P2IE == 1) && (PWM1GIRbits.S1P2IF == 1))
    {
        PWM1GIRbits.S1P2IF = 0;
        if(PWM1_PHASE_A_Slice1Output2_InterruptHandler != ((void*)0))
        {
            PWM1_PHASE_A_Slice1Output2_InterruptHandler();
        }
    }
    else
    {
...
{
    PIR4bits.PWM1PIF = 0;
    if(PWM1_PHASE_A_Period_InterruptHandler != ((void*)0))
    {
        PWM1_PHASE_A_Period_InterruptHandler();
    }
}

void PWM1_PHASE_A_Slice1Output1_SetInterruptHandler(void (* InterruptHandler)(void))
{
    PWM1_PHASE_A_Slice1Output1_InterruptHandler = InterruptHandler;
}

void PWM1_PHASE_A_Slice1Output2_SetInterruptHandler(void (* InterruptHandler)(void))
{
    PWM1_PHASE_A_Slice1Output2_InterruptHandler = InterruptHandler;
}

void PWM1_PHASE_A_Period_SetInterruptHandler(void (* InterruptHandler)(void))
{
    PWM1_PHASE_A_Period_InterruptHandler = InterruptHandler;
}
...
uint16_t PWM1_PHASE_A_GetSlice1Output1DutyCycleRegister(void) {
    return ((uint16_t)PWM1S1P1H << 8) | PWM1S1P1L;
}
